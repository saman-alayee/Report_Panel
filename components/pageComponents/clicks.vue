    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm mt-1" :class="isDarkMode ? 'text-slate-400' : 'text-gray-500'">
          Track and monitor your click traffic data
        </p>
      </div>
      ...
      <div class="flex gap-3">
        <div class="px-4 py-2 rounded-xl" :class="isDarkMode ? 'bg-slate-800' : 'bg-white shadow-sm'">
          <div class="text-xs" :class="isDarkMode ? 'text-slate-400' : 'text-gray-500'">Total Clicks</div>
        ...
        <table class="w-full text-sm">
          <thead>
            <tr :class="isDarkMode ? 'bg-slate-900/50 border-b border-slate-700' : 'bg-gray-50 border-b border-gray-200'">
              ...
              <th class="px-6 py-4 text-left font-semibold" :class="isDarkMode ? 'text-slate-200' : 'text-gray-700'">View ID</th>
            ...
            <tr v-if="store.isLoading">
              <td colspan="7" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center gap-3">
                  <Spinner />
                  <span class="text-sm" :class="isDarkMode ? 'text-slate-400' : 'text-gray-500'">Loading clicks data...</span>
                </div>
              </td>
            </tr>
            ...
            <tr v-else-if="store.data.length === 0">
              <td colspan="7" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center gap-2">
                  ...
                  <span :class="isDarkMode ? 'text-slate-400' : 'text-gray-500'">No data found</span>
                </div>
              </td>
            </tr>
...
const nextPage = () => {
  if (store.currentPage < store.totalPages) {
    store.fetchData(store.currentPage + 1);
  }
};
